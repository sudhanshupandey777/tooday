...
<button type="button" class="btn btn-light status  active   "  style="border-radius: 20px">
  Videos  
</button>
          </li>
...
$displayquery="select * from photo_info where post_type='video' ORDER BY post_date DESC ";
