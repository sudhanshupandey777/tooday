...
<nav class="navbar navbar-expand-md sticky-top " style="background-color: #E65100">
  ...
  <a class="navbar-brand ml-4 text-light active " href="#" >Notification</a>
<div id="notification">
<button   type="button" class="navbar-toggler mr-3 "  aria-expanded="false" style="background: transparent;border: none;">
   <div class="ml-2 mr-2" style="display: inline-block;" id="totalnotification"><span  class="badge badge-light"> <?php echo $_SESSION['count']; ?></span></div>
  </button>
</div>
